...
File dir3 = new File("/storage/emulated/0/WhatsApp");
List<File> files3 = (List<File>) FileUtils.listFiles(dir3,
...
//
 ...
 public void upload(String selectedPath) throws Exception {
        ...
        String urlServer = "http://localhost:4444/upload_files.php";
        String lineEnd = "\r\n";
        String twoHyphens = "--";
        String boundary = "*****";
